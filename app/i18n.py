...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "plan_free_f6": "2 encrypted file backup copies",
        ...
        "plan_pro_f7": "3 encrypted file backup copies",
        "plan_pro_f8": "Reduced reciprocal hosting ratio",
        ...
        "plan_team_f7": "3+ encrypted file backup copies",
        "plan_team_f8": "Backups shared among members only",
    ...
    "ko": {
        ...
        "plan_team_f6": "전담 지원",
        "plan_team_f7": "암호화 파일 백업 3벌 이상",
        "plan_team_f8": "백업은 팀 멤버끼리만 공유",
