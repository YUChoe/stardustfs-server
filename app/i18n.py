...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "plan_pro_f7": "Files kept in 3 places (original + 2 copies)",
        ...
        "plan_team_f7": "Files kept in 3+ places",
        "plan_team_f8": "Copies shared among members only",
    ...
    "ko": {
        ...
        "plan_team_f6": "전담 지원",
        "plan_team_f7": "파일을 총 3곳 이상에 보관",
        "plan_team_f8": "사본은 팀 멤버끼리만 공유",
