...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "feature_backup_title": "Redundant Encrypted Backup",
        "feature_backup_desc": "Files are split into encrypted chunks and copied across several of your devices, so an offline or lost device never means lost data. Hosting devices only ever hold ciphertext they cannot read \u2014 only you hold the keys.",
    ...
    "ko": {
        ...
        "feature_backup_title": "암호화 다중 백업",
        "feature_backup_desc": "파일은 암호화된 청크로 나뉘어 여러 디바이스에 복제됩니다. 한 기기가 꺼져 있거나 분실돼도 데이터를 잃지 않으며, 보관하는 기기는 복호화할 수 없는 암호문만 가집니다 — 키는 오직 나에게 있습니다.",
        "comparison_heading": "StardustFS vs Dropbox",
