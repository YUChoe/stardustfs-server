...
- [x] 3. Checkpoint - 인증 기능 검증
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. 디바이스 관리 구현
  - [x] 4.1 디바이스 서비스 및 라우터 구현
...
- [x] 8. Checkpoint - 전체 기능 검증
  - Ensure all tests pass, ask the user if questions arise.

- [x] 9. 통합 테스트
  - [x] 9.1 통합 테스트 및 conftest 작성
